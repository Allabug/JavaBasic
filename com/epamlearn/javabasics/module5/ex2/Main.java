...
public class Main {
    public static void main(String[] args) {
        ...
        Product product1 = new Product("Milk", "16935792", new Price(new BigDecimal("2.5"), "BYN"));
        Product product2 = new Product("Bread", "16935792", new Price(new BigDecimal("1.75"), "BYN"));
        Product product3 = new Product("Cheese", "16935792", new Price(new BigDecimal("6.40"), "BYN"));
        Product product4 = new Product("Yogurt", "16935792", new Price(new BigDecimal("1.20"), "BYN"));
        Product product5 = new Product("Oil", "16935792", new Price(new BigDecimal("3.60"), "BYN"));
